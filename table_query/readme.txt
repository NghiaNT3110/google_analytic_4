...
===
Note about the Engagement Rate in the Query: If you want an accurate Engagement Rate in the Report, Create a custom calculated field by using this formula in Looker Studio: COUNT_DISTINCT(Engaged Sesion) / COUNT_DISTINCT(Sessions)
